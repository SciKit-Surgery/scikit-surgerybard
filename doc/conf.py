...
# -*- coding: utf-8 -*-
#
# scikit-surgerybard documentation build configuration file, created by
...
# This allows modules to be indexed under the submodule name rather than all appearing under sksurgerybard
modindex_common_prefix = [
    'sksurgerybard.'
]

# General information about the project.
project = u'scikit-surgerybard'
copyright = u"2019, University College London"
author = u'Mian Asbat Ahmad'
...
# The full version, including alpha/beta/rc tags.
# release = sksurgerybard.__version__
...
htmlhelp_basename = 'scikit-surgerybarddoc'
...
latex_documents = [
    ('index', 'scikit-surgerybard.tex',
     u'scikit-surgerybard Documentation',
     u'Mian Asbat Ahmad', 'manual'),
]
...
man_pages = [
    ('index', 'scikit-surgerybard',
     u'scikit-surgerybard Documentation',
     [u'Mian Asbat Ahmad'], 1)
]
