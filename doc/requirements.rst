...
===============================================
Requirements for scikit-surgerybard
===============================================

This is the software requirements file for scikit-surgerybard, part of the
SNAPPY project. The requirements listed below should define
what scikit-surgerybard does. Each requirement can be matched to a unit test that
